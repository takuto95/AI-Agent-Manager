...
作成後、LIFF IDが表示されます（例: `1234567890-AbCdEfGh`）。このIDを控えておきます。
...
// 変更後
const liffId = '1234567890-AbCdEfGh'; // 実際のLIFF IDに置き換え
```
...
// 変更後
uri: 'https://liff.line.me/1234567890-AbCdEfGh' // 実際のLIFF IDに置き換え
```
...
1. **LINEアプリでLIFFを開く**
   - リッチメニューの「タスク一覧」をタップ
   - または、LIFF URLを直接開く: `https://liff.line.me/1234567890-AbCdEfGh`
